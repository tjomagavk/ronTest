...
$dirClub = "./ron";
$img = $dirClub . '/club/resources/images/card.png';
//echo $img . '<br/>';

$message;
if (!newCard($img, $individualCod, $fullNameTranslate, $fullName, $email, $dirClub)) {
...
function newCard($img, $individualCod, $fullNameTranslate, $fullName, $email, $hostUrl)
{
